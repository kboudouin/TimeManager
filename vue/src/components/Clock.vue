...
const fetchData = async () => {
  const resp = await axios.get(`http://54.88.141.45:4000/api/clocks/${id}`);
...
const clock = async () => {
  await axios.post(`http://54.88.141.45:4000/api/clocks/${id}?status=true`);
  fetchData();
};
...
const refresh = async () => {
  ...
  await axios.post(`http://54.88.141.45:4000/api/clocks/${id}?status=false`);
  await axios.post(`http://54.88.141.45:4000/api/workingtimes/${id}?start=${sTime.value}&end=${sTime.value}`);
  fetchData();
};
